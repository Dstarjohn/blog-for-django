...
urlpatterns = [
    ...
    path('slideDis', views.to_slide, name='slideDis'),  # 显示列表页面
    path('slideAddDis', views.add_slide_dis, name='slideAddDis'),  # 显示添加页面
    path('slideEditDis/<int:id>/', views.edit_slide_dis, name='slideEditDis'),  # 显示修改页面
    path('slide', views.SlideView.as_view(), name='slide'),  # API
    ...
    path('linkDis', views.links_dis, name='linkDis'),  # 显示列表页面
    path('linkAddDis', views.link_add_dis, name='linkAddDis'),  # 显示添加页面
